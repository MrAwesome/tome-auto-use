...
function _M:checkSetTalentAuto(tid, v, opt)
    ...
    if v then
        local doit = function()
            ...
            Dialog:simplePopup("Automatic use enabled",
                t.name:capitalize() .. " will now be used as often as possible automatically.")
        end
        ...
        if t and t.requires_target then list[#list + 1] =
            "- requires a target, your last hostile one will be automatically used" end
        ...
        if opt == 102 then list[#list + 1] =
            "- you LEFT CLICK an enemy and there are no enemies visible ??? lol delet this" end
        ...
        if opt == 108 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies are not visible and will deactivate if enemies appear" end
        if opt == 109 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies are visible, and will deactivate if they are not" end
        ...
        if opt == 116 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and in range and you are above 80% hp" end
        if opt == 117 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and in range and you are below 80% hp" end
        if opt == 118 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and in range and you are above 60% hp" end
        if opt == 119 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and in range and you are below 60% hp" end
        if opt == 120 then list[#list + 1] = "- you LEFT CLICK an enemy and enemies and within two tiles" end
        if opt == 121 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and within two tiles and you are above 80% hp" end
        if opt == 122 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and within two tiles and you are below 80% hp" end
        if opt == 123 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and within two tiles and you are above 60% hp" end
        if opt == 124 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and within two tiles and you are below 60% hp" end
        if opt == 125 then list[#list + 1] = "- you LEFT CLICK an enemy and enemies and adjacent" end
        if opt == 126 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and adjacent and you are above 80% hp" end
        if opt == 127 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and adjacent and you are below 80% hp" end
        if opt == 128 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and adjacent and you are above 60% hp" end
        if opt == 129 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies and adjacent and you are below 60% hp" end
        ...
        if opt == 136 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and in range and above 80% hp" end
        if opt == 137 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and in range and below 80% hp" end
        if opt == 138 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and in range and above 60% hp" end
        if opt == 139 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and in range and below 60% hp" end
        if opt == 140 then list[#list + 1] = "- you LEFT CLICK an enemy and enemies but no elites and within two tiles" end
        if opt == 141 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and within two tiles and above 80% hp" end
        if opt == 142 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and within two tiles and below 80% hp" end
        if opt == 143 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and within two tiles and above 60% hp" end
        if opt == 144 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and within two tiles and below 60% hp" end
        if opt == 145 then list[#list + 1] = "- you LEFT CLICK an enemy and enemies but no elites and adjacent" end
        if opt == 146 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and adjacent and above 80% hp" end
        if opt == 147 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and adjacent and below 80% hp" end
        if opt == 148 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and adjacent and above 60% hp" end
        if opt == 149 then list[#list + 1] =
            "- you LEFT CLICK an enemy and enemies but no elites and adjacent and below 60% hp" end
        ...
        if opt == 153 then list[#list + 1] =
            "- you LEFT CLICK an enemy and at least 2 tiles between you with no elites and hp>80%" end
        if opt == 154 then list[#list + 1] =
            "- you LEFT CLICK an enemy and at least 2 tiles between you with no elites and hp>60%" end
        if opt == 155 then list[#list + 1] =
            "- you LEFT CLICK an enemy and at least 2 tiles between you but in range with no elites and hp>80%" end
        if opt == 156 then list[#list + 1] =
            "- you LEFT CLICK an enemy and at least 2 tiles between you but in range with no elites and hp>60%" end
        if opt == 157 then list[#list + 1] = "- you LEFT CLICK an enemy and you left click a valid target" end

        if #list == 0 then
            doit()
        else
            Dialog:yesnoLongPopup("Automatic use",
